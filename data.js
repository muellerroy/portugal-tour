  ...
  regions: [
    {
      ...
      color: "#1B4F72",
      spots: [
        { id: "s0101", name: "Belém (Jerónimos-Kloster, Torre de Belém)", lat: 38.6979, lon: -9.2062, category: "kultur", cost: "Kloster/Turm Eintritt ca. 10€, Außenbesichtigung frei", access: "Gut ausgeschilderte Parkplätze/Camper-Stellplätze in Belém", description: "UNESCO-Weltkulturerbe im manuelinischen Stil. Pastéis de Belém direkt gegenüber probieren.", why: "Eines der eindrucksvollsten Beispiele der manuelinischen Spätgotik weltweit – erbaut aus dem Reichtum der Entdeckungsfahrten. Der Kreuzgang gilt als einer der schönsten Europas, und im Kloster liegen Vasco da Gama und der Dichter Camões begraben.", photoQuery: "Jerónimos Monastery Lisbon", amenities: "Parkplatz, Toiletten, Cafés", source: "core" },
        { id: "s0102", name: "LX Factory", lat: 38.7036, lon: -9.1783, category: "kultur", cost: "Eintritt frei, Konsum kostet", access: "Unter der Ponte 25 de Abril, begrenzte Parkplätze", description: "Ehemaliges Fabrikgelände mit Läden, Cafés, Streetart.", why: "Ein authentisches Stück Lissabonner Kreativszene: In den Hallen einer alten Textilfabrik reihen sich Concept Stores, Buchläden, Street-Art und Cafés – lebendig, bunt und ohne Eintritt.", photoQuery: "LX Factory Lisbon", amenities: "Restaurants, WC, Wifi in Cafés", source: "core" },
    ...
    },
    {
      ...
      color: "#1B4F72",
      spots: [
        { id: "s0201", name: "Palácio Nacional da Pena", lat: 38.7876, lon: -9.3906, category: "kultur", cost: "Eintritt ca. 14-20€", access: "Serpentinenstraße, besser mit Bus/Tuk-Tuk ab Sintra-Zentrum", description: "Romantisches Königsschloss, UNESCO-Kulturlandschaft seit 1995.", why: "Ein märchenhaftes Königsschloss auf einem Bergrücken der Serra de Sintra, das mit seinen knallbunten Türmen und Stilelementen aus Romantik, Neugotik und Manuelinik zum UNESCO-Welterbe gehört.", photoQuery: "Pena Palace Sintra", amenities: "Parkplatz (begrenzt), Café", source: "core" },
        { id: "s0202", name: "Cabo da Roca", lat: 38.7811, lon: -9.4986, category: "natur", cost: "kostenlos", access: "Gut ausgebaute Straße, großer Parkplatz", description: "Westlichster Festlandpunkt Europas, archaische Klippenlandschaft.", why: "Der westlichste Punkt des europäischen Festlands – hier fällt die Küste rund 140 m senkrecht zum tosenden Atlantik ab. Ein archaischer, oft windumtoster Ort mit Leuchtturm.", photoQuery: "Cabo da Roca", amenities: "Parkplatz, Kiosk, WC", source: "core" },
    ...
    },
    {
      ...
      color: "#C1602A",
      spots: [
        { id: "s0301", name: "Évora Altstadt", lat: 38.5714, lon: -7.9135, category: "kultur", cost: "kostenlos, Kathedrale/Kapelle je ca. 3-5€", access: "Camper-Parkplätze außerhalb der Altstadtmauer", description: "UNESCO-Weltkulturerbe, Römischer Tempel, Capela dos Ossos.", why: "Eine lebendige Studentenstadt und ein Freilichtmuseum zugleich: Der römische Diana-Tempel, die Kathedrale und die makabre Capela dos Ossos machen die UNESCO-Altstadt zum Herzen des Alentejo.", photoQuery: "Roman Temple of Evora", amenities: "Parkplätze, Restaurants, WC", source: "core" },
        { id: "s0302", name: "Cromeleque dos Almendres", lat: 38.5578, lon: -8.0525, category: "natur", cost: "kostenlos", access: "Letztes Stück unbefestigte Straße", description: "Megalithischer Steinkreis, älter als Stonehenge.", why: "Ein megalithischer Steinkreis aus dem 6. Jahrtausend v. Chr. – rund 2000 Jahre älter als Stonehenge. Fast 100 Granitmonolithen stehen in mystischer Stille zwischen Korkeichen.", photoQuery: "Almendres Cromlech", amenities: "keine", source: "core" },
        ...
        { id: "s0304", name: "Monsaraz", lat: 38.4400, lon: -7.3789, category: "kultur", cost: "kostenlos", access: "Parkplatz vor dem Ortseingang, autofrei im Kern", description: "Mittelalterliches Dorf mit Burg über dem Alqueva-Stausee.", why: "Ein winziges, autofreies Dorf hinter einer mächtigen Mauer, hoch über dem Alqueva-Stausee. Weiß getünchte Häuser, mittelalterliche Burg und Sternenhimmel ohne Lichtverschmutzung.", photoQuery: "Monsaraz", amenities: "Parkplatz, Restaurants", source: "core" },
    ...
    },
    {
      ...
      spots: [
        ...
        { id: "s0604", name: "Cabo de São Vicente", lat: 37.0206, lon: -8.9707, category: "natur", cost: "kostenlos", access: "Gute Straße ab Sagres", description: "Klippen, Leuchtturm, bester Sonnenuntergang Portugals.", why: "Das 'herbe Ende' Europas: Auf hohen Klippen über dem Atlantik, umtost vom Wind, mit dem stärksten Leuchtfeuer Portugals. Traumhafter Sonnenuntergang am 'Ende der Welt'.", photoQuery: "Cape St. Vincent", amenities: "Parkplatz, Imbisswagen", source: "core" },
        { id: "s0605", name: "Fortaleza de Sagres", lat: 37.0058, lon: -8.9366, category: "kultur", cost: "Eintritt ca. 3€", access: "Parkplatz an der Festung", description: "Heinrich der Seefahrer, steinerne 'Windrose'.", why: "Hier lebte Heinrich der Seefahrer und legte den Grundstein für Portugals Seefahrernation. In der Festung liegt eine rätselhafte 43-m-'Windrose' aus Stein.", photoQuery: "Fortress of Sagres", amenities: "Parkplatz, WC", source: "core" },
    ...
    },
    {
      ...
      color: "#1B4F72",
      spots: [
        { id: "s0901", name: "Nazaré - Praia do Norte", lat: 39.6072, lon: -9.0761, category: "natur", cost: "kostenlos", access: "Parkplatz beim Leuchtturm", description: "Weltrekord-Riesenwellen (bis 26 m), berühmter Surfspot.", why: "Weltberühmter Riesenwellen-Surfspot: Im Winter türmt der unterseeische Nazaré-Canyon Wellen von über 20 m auf. Vom Forte de São Miguel Arcanjo beobachtet man die besten Surfer der Welt.", photoQuery: "Nazare Portugal big waves", amenities: "Parkplatz, Aussichtspunkt", source: "core" },
        ...
        { id: "s0903", name: "Mosteiro da Batalha", lat: 39.6608, lon: -8.8256, category: "kultur", cost: "Eintritt ca. 6€", access: "Parkplatz am Kloster", description: "Gotisches Meisterwerk, UNESCO-Weltkulturerbe seit 1983.", why: "Ein gotisches Meisterwerk voller Seele und Spiritualität, als Dank für den Sieg in der Schlacht von Aljubarrota 1385 erbaut. UNESCO-Welterbe mit der unvollendeten 'Capela Imperfeitas'.", photoQuery: "Batalha Monastery", amenities: "Parkplatz, WC", source: "core" },
        { id: "s0904", name: "Mosteiro de Alcobaça", lat: 39.5478, lon: -8.9800, category: "kultur", cost: "Eintritt ca. 6€", access: "Parkplatz im Ortszentrum", description: "Letzte Ruhestätte von Pedro & Inês, UNESCO seit 1989.", why: "Hier ruhen die tragisch Liebenden Pedro und Inês in kunstvollen Sarkophagen, einander gegenüber, 'damit sie beim Jüngsten Gericht als Erstes einander sehen'. UNESCO-Welterbe.", photoQuery: "Alcobaca Monastery", amenities: "Parkplatz, WC", source: "core" },
    ...
    },
    {
      ...
      color: "#1B4F72",
      spots: [
        { id: "s1101", name: "Porto - Ribeira & Ponte Luís I", lat: 41.1405, lon: -8.6119, category: "kultur", cost: "kostenlos", access: "Parkhäuser, Altstadt eng und steil", description: "Historisches Flussufer-Viertel, Brücke von Eiffels Schüler erbaut.", why: "Die Altstadt Portos fällt in bunten Zügen zum Douro ab – überspannt von der eisernen Ponte Luís I, die ein Eiffel-Schüler entwarf. Ribeira ist UNESCO-Welterbe.", photoQuery: "Ribeira Porto", amenities: "Parkhaus, Restaurants", source: "core" },
        { id: "s1102", name: "Bahnhof São Bento (Azulejos)", lat: 41.1456, lon: -8.6108, category: "kultur", cost: "kostenlos", access: "Zu Fuß von der Altstadt", description: "Beeindruckende Azulejo-Wandbilder von 1916.", why: "Einer der schönsten Bahnhöfe der Welt: Über 20.000 handbemalte Azulejo-Kacheln erzählen im Vestibül die Geschichte Portugals.", photoQuery: "Sao Bento railway station", amenities: "keine speziell", source: "core" },
        ...
        { id: "s1104", name: "Douro-Tal bei Pinhão", lat: 41.1892, lon: -7.5486, category: "natur", cost: "kostenlos, Weinproben variieren", access: "Kurvige Landstraße N222", description: "Älteste offiziell abgegrenzte Weinregion der Welt (seit 1756).", why: "Die älteste offiziell abgegrenzte Weinregion der Welt (seit 1756). Steile, von Hand terrassierte Weinberge fallen zum Fluss ab – ein UNESCO-Welterbe von atemberaubender Schönheit.", photoQuery: "Douro Valley vineyards", amenities: "Parkplatz, Restaurants", source: "core" },
    ...
    },
    {
      ...
      color: "#C1602A",
      spots: [
        { id: "s1201", name: "Guimarães Altstadt", lat: 41.4425, lon: -8.2918, category: "kultur", cost: "kostenlos, Burg ca. 2€", access: "Parkhäuser am Stadtrand", description: "'Wiege der Nation', UNESCO-Weltkulturerbe, Paço dos Duques.", why: "Die 'Wiege der Nation': Hier wurde der erste König Portugals geboren. Die perfekt erhaltene mittelalterliche Altstadt ist UNESCO-Welterbe.", photoQuery: "Guimaraes historic centre", amenities: "Parkhaus, Restaurants", source: "core" },
        { id: "s1202", name: "Bom Jesus do Monte, Braga", lat: 41.5561, lon: -8.3781, category: "kultur", cost: "Standseilbahn ca. 2€, Gelände frei", access: "Parkplatz am Fuß der Treppe", description: "Barocke Wallfahrtskirche, historische Standseilbahn seit 1882.", why: "Eine barocke Wallfahrtskirche mit spektakulärer Zickzack-Treppe – hinauf bringt einen die älteste wasserballastbetriebene Standseilbahn der Welt (seit 1882).", photoQuery: "Bom Jesus do Monte", amenities: "Parkplatz, Restaurants", source: "core" },
    ...
    },
    {
      ...
      color: "#4C7A5E",
      spots: [
        { id: "s1301", name: "Soajo (Espigueiros)", lat: 41.8722, lon: -8.2506, category: "kultur", cost: "kostenlos", access: "Kurvige Bergstraße", description: "Traditionelle Kornspeicher auf Stelzen (Espigueiros), Granitdorf.", why: "Ein Granitdorf mit den ikonischen Espigueiros – jahrhundertealte Kornspeicher auf Stelzen, die wie kleine Steinsärge wirken. Tor zum wilden Peneda-Gerês-Nationalpark.", photoQuery: "Soajo espigueiros", amenities: "kleiner Parkplatz", source: "core" },
    ...
    },
    {
      ...
      color: "#C1602A",
      spots: [
        { id: "s1401", name: "Serra da Estrela (Torre)", lat: 40.3269, lon: -7.6144, category: "natur", cost: "Parkgebühr ca. 2-5€", access: "Kurvenreiche Bergstraße, im Winter ggf. Schneeketten nötig", description: "Höchstes Festlandgebirge Portugals, Wasserfälle, Wollindustrie-Tradition.", why: "Das höchste Gebirge des portugiesischen Festlands (bis 1993 m). Gletschertäler, Wasserfälle und im Winter sogar Schnee – dazu die kuschelige Burel-Wolltradition.", photoQuery: "Serra da Estrela", amenities: "Parkplatz, Kiosk", source: "core" },
        ...
        { id: "s1403", name: "Convento de Cristo, Tomar", lat: 39.6033, lon: -8.4147, category: "kultur", cost: "Eintritt ca. 6€", access: "Parkplatz am Fuß des Hügels", description: "Templerordens-Festung, manuelinisches 'Fenster von Tomar', UNESCO seit 1983.", why: "Eine gewaltige Templerordens-Festung über der Stadt: Das manuelinische 'Fenster von Tomar' gilt als eines der berühmtesten Steinmetz-Kunstwerke Portugals. UNESCO-Welterbe.", photoQuery: "Convent of Christ Tomar", amenities: "Parkplatz, WC", source: "core" },
        { id: "s1404", name: "Castelo de Almourol", lat: 39.4939, lon: -8.3667, category: "kultur", cost: "Boot ca. 3€", access: "Nur per Boot erreichbar, Parkplatz am Ufer", description: "Burg auf einer Felseninsel mitten im Tejo, erbaut 1171.", why: "Eine märchenhafte Burg auf einer Felseninsel mitten im Tejo, nur per Boot erreichbar – der Legende nach von Templern gehalten.", photoQuery: "Almourol Castle", amenities: "Parkplatz, kleiner Kiosk", source: "core" },
